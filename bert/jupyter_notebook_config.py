...
c.NotebookApp.notebook_dir = '/host_shared_dir'
...
#c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$VEcLXamC+5HSWWHTPm+34Q$x92D7dW8QSePfFfXqRPgrA'
